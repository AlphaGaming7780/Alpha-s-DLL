...
void CvLuaCity::PushMethods(lua_State* L, int t)
{
	...
	Method(IsCoastal);
	Method(SetCoastal);
	Method(IsAllowsWaterProduction);
	Method(SetAllowsWaterProduction);
...
//------------------------------------------------------------------------------
//void SetCoastal(bool bCoastal, bool bReset, int iMinWaterSize = -1);
int CvLuaCity::lSetCoastal(lua_State* L)
{
	return BasicLuaMethod(L, &CvCity::SetCoastal);
}
//------------------------------------------------------------------------------
//bool isAllowsWaterProduction();
int CvLuaCity::lIsAllowsWaterProduction(lua_State* L)
{
	return BasicLuaMethod(L, &CvCity::isAllowsWaterProduction);
}
//------------------------------------------------------------------------------
//void SetAllowsWaterProduction(bool AllowsWaterProduction);
int CvLuaCity::lSetAllowsWaterProduction(lua_State* L)
{
	return BasicLuaMethod(L, &CvCity::SetAllowsWaterProduction);
}
//------------------------------------------------------------------------------
