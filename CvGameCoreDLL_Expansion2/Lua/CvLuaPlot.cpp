...
void CvLuaPlot::PushMethods(lua_State* L, int t)
{
	...
	Method(IsMountain);
	Method(IsAllowsSailLand)
	Method(SetAllowsSailLand)
...
//------------------------------------------------------------------------------
//bool IsAllowsSailLand();
int CvLuaPlot::lIsAllowsSailLand(lua_State* L)
{
	return BasicLuaMethod(L, &CvPlot::IsAllowsSailLand);
}
//------------------------------------------------------------------------------
//void SetAllowsSailLand(bool AllowsSailLand);
int CvLuaPlot::lSetAllowsSailLand(lua_State* L)
{
	return BasicLuaMethod(L, &CvPlot::SetAllowsSailLand);
}
//------------------------------------------------------------------------------
