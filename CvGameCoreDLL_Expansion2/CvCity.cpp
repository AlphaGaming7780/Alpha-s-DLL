...
CvCity::CvCity() :
	...
	, m_bCoastal("CvCity::m_bCoastal", m_syncArchive)
	, m_bAllowsWaterProduction("CvCity::m_bAllowsWaterProduction", m_syncArchive)
...
void CvCity::init(int iID, PlayerTypes eOwner, int iX, int iY, bool bBumpUnits, bool bInitialFounding)
{
	...
	SetCoastal(false,true);
	SetAllowsWaterProduction(false);
...
//	--------------------------------------------------------------------------------
bool CvCity::isCoastal(int) const
{	
	VALIDATE_OBJECT
	return m_bCoastal;
}
//	--------------------------------------------------------------------------------
void CvCity::SetCoastal(bool bCoastal, bool bReset, int iMinWaterSize)
{	
	VALIDATE_OBJECT
	if (bReset) {
		m_bCoastal = plot()->isCoastalLand(iMinWaterSize);
	}
	else if(isCoastal() != bCoastal) {
		m_bCoastal = bCoastal;
	}
}
//	--------------------------------------------------------------------------------
bool CvCity::isAllowsWaterProduction() const
{
	VALIDATE_OBJECT
		return m_bAllowsWaterProduction;
}
//	--------------------------------------------------------------------------------
void CvCity::SetAllowsWaterProduction(bool bAllowsWaterProduction)
{
	VALIDATE_OBJECT
		m_bAllowsWaterProduction = bAllowsWaterProduction;
}
...
void CvCity::read(FDataStream& kStream)
{
	...
	kStream >> m_bCoastal;
	kStream >> m_bAllowsWaterProduction;
